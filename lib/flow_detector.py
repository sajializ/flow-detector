...
class FlowDetector:
    ...
    def __init__(self, sniffer_instance = None, collector_instance = None, ifname = None):
        self.sniffer = sniffer_instance if sniffer_instance is not None else sniffer.Sniffer(ifname)
        self.collector = collector_instance if collector_instance is not None else collector.Collector()
